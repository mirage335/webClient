...
Will either find binaries for firefox/chromium/etc installed (eg. /usr/bin/firefox) or if available will use binaries installed in overriding locations (eg. ~/core/installations/firefox/firefox, "$scriptAbsoluteFolder"/_local/setups/firefox/firefox/firefox).
...
'
_heading2 'Fork'
_t 'Usually, bookmark/password export, and sync services, are sufficient. Usually git repository tracking of entire web browser profile history is not necessary or desirable.

To fork nevertheless...

EITHER use &#39;ubiquitous_bash&#39; fork script and copy &#39;_prog&#39;, &#39;_local/ops.sh&#39;, &#39;_lib/desktop&#39; from &#39;_webClient&#39; (preferable) OR download &#39;webClient&#39; and change git remote origin push/pull URI.

Remove "_local/h" ".gitignore" exlcusion to track web browser profile under git repository.'
_ _page
_heading1 'Design'
_t 'Ubiquitous Bash FakeHome virtualization redirects the apparent home directory as seen by FireFox, Chromium, etc.
